...
import logging
import pprint
import requests ## @Mellavin - Use python 'requests' instead of urllib2 - taken from payment_payment module from Odoo V 11
import urllib
import urllib2
import werkzeug
...
class PaypalController(http.Controller):
    ...
    def paypal_validate_data(self, **post):
        ...
        # urequest = urllib2.Request(validate_url, werkzeug.url_encode(new_post))  ## @Mellavin - Use python 'requests' instead of urllib2 - taken from payment_payment module from Odoo V 11
        # uopen = urllib2.urlopen(urequest)
        # resp = uopen.read()
        # urequest = requests.post(validate_url, new_post)                           ## @Mellavin - Use python 'requests' instead of urllib2 - taken from payment_payment module from Odoo V 11
